...
st.title("Dana Syirkah Temporer")

# Folder tempat file disimpan
folder_path = "data/Dana Syirkah Temporer"

# Urutan file yang ingin ditampilkan
file_order = [
    "Simpanan Lancar Mudharabah Anggota.xlsx",
    "Simpanan Berjangka Anggota.xlsx",
    "Pembiayaan Yang Diterima.xlsx",
    "Pembiayaan LPDB.xlsx",
    "Total Dana Syirkah Temporer.xlsx"
]
