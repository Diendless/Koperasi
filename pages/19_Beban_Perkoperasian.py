...
st.title("Beban Perkoperasian")

# Folder tempat file disimpan
folder_path = "data/Beban Perkoperasian"

# Urutan file yang ingin ditampilkan
file_order = [
    "Beban Pengawas dan Pengurus Koperasi.xlsx",
    "Beban Pembinaan Pendidikan dan Pelatihan.xlsx"
]
